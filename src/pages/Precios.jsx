      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="w-full flex justify-center items-center text-white">
          <div className="text-center flex flex-col gap-4">
            ...
            <span>Lente angular <i class="fa-solid fa-arrow-right"></i> <span className="font-bold"> $34.999</span></span>
            <span>Lente Pro <i class="fa-solid fa-arrow-right"></i> <span className="font-bold"> $47.999</span></span>
            <span>Tripode <i class="fa-solid fa-arrow-right"></i> <span className="font-bold"> $34.999</span></span>
